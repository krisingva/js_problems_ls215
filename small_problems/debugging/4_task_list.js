...
// Answer: The problem is with the delete operator used in completeTasks. This
// operator should be used on object properties but non-configurable properties
// cannot be removed (such as array elements). Instead of deleting the element
// from the array, the array property represented by the element's index will be
// set to the value undefined.

// To fix: Use the Array.splice method instead of the delete operator
...
// The Array.prototype.shift() method provides the behavior appropriate for our
// code. It removes the first element of an array, shifts the values at
