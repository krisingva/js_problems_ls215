...
addMember('232-1191', 'Rachel Garcia');
addMember('Earl 5mith', '331-9191');
addMember('Earl $mith', '331-9191');
addMember('Earl Smith', '1-800-331-9191');
addMember('EarlSmith', '331-9191');
addMember('', '331-9191');
addMember('Earl Smith', 3319191);
addMember('Earl Smith', '');

console.log(memberDirectory);

// answer: the regex used to validate the name uses the class shortcut w that
// includes alpha and numeric characters (as well as _). To only allow for alpha
// characters use: /[a-z]/i