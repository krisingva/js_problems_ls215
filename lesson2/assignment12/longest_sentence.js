...
// Double up the punctuations so that we can split the text to sentences using
// regex, then filter out any elements that do not start with a word
// character:
...
function longestSentence(text) {
  let sentences = toSentences(text);
